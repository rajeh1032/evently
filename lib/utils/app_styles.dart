...
class AppStyles {
  ...
  static TextStyle medium14Red = GoogleFonts.inter(
  ...
  static TextStyle medium18primaryLight = GoogleFonts.inter(
      fontSize: 18, fontWeight: FontWeight.w500, color: AppColors.primaryLight);
